...
const subject = `Invoice #{{invoiceNumber}}- Client: {{contactCompanyName}}, Due Soon`;
   ...
   <!-- Header -->
    <div style="margin-bottom: 12px; background: white; border-color:{{primaryColor}}; border-bottom: 3px solid {{primaryColor}}; border-radius: 8px; text-align: center; font-family: Arial, Helvetica, sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              <td>
                <h2 style="margin: 0 0 15px 0; font-weight: 600; letter-spacing: 0.025em;">INVOICE PAYMENT<span style="color: {{primaryColor}};"> DUE SOON</span></h2>
              </td>
            </tr>
        </table>
    </div>    
...
function generateAndSaveHTML() {
  try {
    ...
    const outputFile = path.join(__dirname, "./html_output/invoice4.html");
